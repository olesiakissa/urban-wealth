    ...
    db.collection("problem").insertOne(
        {
            ...
            text: prob.text,
            date: prob.date,
            category_id: prob.category_id,
            subcategory_id: prob.subcategory_id,
            author: prob.author,
            district_id: prob.district_id,
            media: ['2.png']
        }
    )
};
...
module.exports.insertSolution = function (solut) {
    db.collection("solution").insertOne(
        {
            id: solut.id,
            title: solut.title,
            text: solut.text,
...
module.exports.insertDistrict = function (dist) {
    db.collection("district").insertOne(
        {id: dist.id, name: dist.name, svgpath: dist.svgpath}
    );
};
