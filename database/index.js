...
// for each type
module.exports.toJsonDistrict = (object) => {
    return {
        id: object.id, 
        name: object.name, 
...
// Promise works fine, but it is not synchronized with other promises
// so I can't normally use .then() after it
module.exports.insert = (collectionName, toJsonFunc) => {
    return new Promise((resolve, reject) => {
        mongodb.connect(url)
           .then(conn => {
                conn.db(connDB).collection(collectionName).insertOne(toJsonFunc)
